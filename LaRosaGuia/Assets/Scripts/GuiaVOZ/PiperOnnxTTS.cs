...
namespace LuckArkman.XR.Main
{
    ...
    public class PiperOnnxTTS : MonoBehaviour
    {
        ...
        private static string TextoParaFonemas(string texto)
        {
            ...
            // Correção 1: Aplicado o global:: aqui no StringBuilder
            var fonemas = new global::System.Text.StringBuilder();
        ...
        /// </summary>
        // Correção 2: Aplicado o global:: aqui no Action do Sintetizar
        public void Sintetizar(string texto, global::System.Action<AudioClip> onPronto)
        {
            if (!_pronto)
            {
        ...
        // Correção 3: Aplicado o global:: aqui no Action da Coroutine
        private IEnumerator SintetizarCoroutine(string texto, global::System.Action<AudioClip> onPronto)
        {
